...
sab <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_sab2023-10-14.xlsx")
ede <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_ede2023-10-14.xlsx")
bib <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_bib2023-10-14.xlsx")
rhea <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_rhea2023-10-14.xlsx")
kanc <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_kanc2023-10-14.xlsx")
moba <- read_excel("/Users/ymou/helix_project/results/airpollution_total_mainoutcome_moba2023-10-14.xlsx")
meta_n <- read_excel("/Users/ymou/helix_project/results/meta_n2023-10-15.xlsx")
```
...
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot" & Predictor == "hs_no2_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  smlab = "NO2 and count-based AL score",
  fs.smlab = 12
)
dev.off()
...
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot" & Predictor == "hs_pm10_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM10 and count-based AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot" & Predictor == "hs_pm25_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5 and count-based AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot" & Predictor == "hs_pm25abs_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5abs and count-based AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, eval=T, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot_wavg" & Predictor == "hs_no2_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "NO2 and count-based wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot_wavg" & Predictor == "hs_pm10_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM10 and count-based wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot_wavg" & Predictor == "hs_pm25_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5 and count-based wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_2_tot_wavg" & Predictor == "hs_pm25abs_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5abs and count-based wavg AL score",
  fs.smlab = 12
)
```
...
```{r, eval=T, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot" & Predictor == "hs_no2_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "NO2 and continuous AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot" & Predictor == "hs_pm10_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM10 and continuous AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot" & Predictor == "hs_pm25_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5 and continuous AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot" & Predictor == "hs_pm25abs_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5abs and continuous AL score",
  fs.smlab = 12
)
dev.off()
```
...
```{r, eval=T, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot_wavg" & Predictor == "hs_no2_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "NO2 and continuous wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot_wavg" & Predictor == "hs_pm10_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM10 and continuous wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot_wavg" & Predictor == "hs_pm25_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5 and continuous wavg AL score",
  fs.smlab = 12
)
```
...
```{r, fig.asp = 0.8, fig.width=9}
df_test <- df_meta %>%
  filter(Outcome == "AL_z2_tot_wavg" & Predictor == "hs_pm25abs_yr_hs_t") %>%
  filter(cohort != "total")
test <- metagen(
  TE = beta,
  seTE = se,
...
forest(test,
  ...
  plotwidth = "10cm",
  colgap.forest.left = "2cm",
  smlab = "PM2.5abs and continuous wavg AL score",
  fs.smlab = 12
)
```
