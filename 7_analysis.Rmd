...
write.xlsx(tbl, file = paste("/Users/ymou/helix_project/results/", "tableone", ".xlsx", sep = ""), noSpace = T, rowNames = TRUE, col.names = TRUE)
```
...
pm25abs <- glm(
  data = complete(imp_full, n = 25), formula = AL_z2_tot ~ hs_pm25abs_yr_hs_t + e3_sex + hs_child_age_years + h_ethnicity_cauc + cohort + hs_mvpa + hs_sd_wk + FAS_cat + h_native_2cat + h_edumc + h_edufc + h_marital_2cat + h_age + h_parity + e3_asmokyn_p + e3_alcpreg_yn + hs_smk_parents + hs_globalexp_2cat,
  family = "gaussian"
)
...
colnames(mod_tbl1) <- c('Outcome', "Predictor", 
                       'beta_mod1', '95ci_mod1', 'pvalue_mod1', 
                       'beta_mod2', '95ci_mod2', 'pvalue_mod2',  
                       'beta_mod3', '95ci_mod3', 'pvalue_mod3', 
                       'beta_mod4', '95ci_mod4', 'pvalue_mod4',
