...
dt_p1$es <- paste0(dt_p1$exp_beta_mod4, " (", dt_p1$exp_cilo_mod4, "-", dt_p1$exp_cihi_mod4, ")")
```
...
p1 <- ggplot(
  ...
  guides(col = guide_legend(nrow = 5, reverse = T, title = "Count-based ALS",
                            title.position = "top")) +
...
combined_plot <- p1 + table_es + plot_layout(ncol = 2, widths = c(1, 0.5))
...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-countAL.png", width = 15, height = 10, units = "in", dpi = 300)
```
...
dt_p3$es <- paste0(dt_p3$beta, " (", dt_p3$low, "-", dt_p3$hi, ")")
```
...
p3 <- ggplot(
  ...
  guides(color = guide_legend(nrow = 5, reverse = T, title = "Continuous ALS",
                              title.position = "top")) +
  facet_wrap(~Predictor, strip.position = "left", nrow = 9, scales = "free_y", labeller = labeller(Predictor = label_parsed)) +
  # scale_y_continuous(limits = c(-1, 6), breaks = c(-1, 0, 1, 2, 3, 4, 5, 6)) +
  theme(
...
# Combine plots using patchwork
combined_plot <- p3 + table_es + plot_layout(ncol = 2, widths = c(1, 0.5))
...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-continuousAL.png", width = 15, height = 10, units = "in", dpi = 300)
```
...
dt_p9$es <- paste0(dt_p9$exp_beta_mod4, " (", dt_p9$exp_cilo_mod4, "-", dt_p9$exp_cihi_mod4, ")")
...
p9 <- ggplot(
  ...
  # scale_y_continuous(limits = c(-1, 6), breaks = c(-1, 0, 1, 2, 3, 4, 5, 6)) +
  guides(col = guide_legend(nrow = 3, reverse = F, title = "Road traffic Noise levels (dB)",
                            title.position = "top")) +
  theme(
    axis.text.y = element_blank(),
    axis.ticks.y = element_blank(),
...
# Combine plots using patchwork
combined_plot <- p9 + table_es + plot_layout(ncol = 2, widths = c(1, 1))
...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-countAL-noise.png", width = 15, height = 5, units = "in", dpi = 300)
```
...
dt_p10$es <- paste0(dt_p10$beta, " (", dt_p10$low, "-", dt_p10$hi, ")")
...
# Combine plots using patchwork
combined_plot <- p10 + table_es + plot_layout(ncol = 2, widths = c(1, 1))
...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-continuousAL-noise.png", width = 15, height = 5, units = "in", dpi = 300)
```
