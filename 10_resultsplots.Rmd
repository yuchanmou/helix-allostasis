...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-countAL-noise.png", width = 15, height = 4.2, units = "in", dpi = 300)
```
...
```{r, eval=F}
ggsave("/Users/ymou/helix_project/results/Fig/fig-continuousAL-noise.png", width = 15, height = 4.2, units = "in", dpi = 300)
```
