...
(SAB_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'SAB') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'SAB') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(EDEN_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'EDEN') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'EDEN') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(BIB_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'BIB') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'BIB') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(RHEA_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'RHEA') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'RHEA') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(KANC_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'KANC') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'KANC') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(MOBA_1 <- boxGrob(str_glue('With all biomarkers\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(cohort == 'MOBA') %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(cohort == 'MOBA') %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
...
(tot <- boxGrob(str_glue('Total study sample\n n = {min} ~ {max}',
                           min = nrow(df_final %>% filter(!is.na(hs_lden_c_s) & !is.na(AL_1_tot))),
                           max = nrow(df_final %>% filter(!is.na(hs_no2_yr_hs_t) & !is.na(AL_1_tot)))),
